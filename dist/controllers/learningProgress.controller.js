...
export const learningProgressController = {
    ...
    async updateModuleProgress(req, res) {
        try {
            ...
            const { status, progressPercentage, timeSpent, score, maxScore, passed, rating, feedback, progressData } = req.body;
            ...
            try {
                ...
                if (rating !== undefined) {
                    ...
                    if (allRatings.length > 0) {
                        ...
                        await LearningModule.update({ averageRating: parseFloat(avg.toFixed(2)) }, { where: { id: moduleId } });
                    }
                }
            }
            catch (e) {
