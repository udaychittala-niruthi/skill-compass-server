...
const CourseSeeder = async (_sequelize, transaction) => {
    ...
    try {
        ...
        const inputCourses = Object.entries(courses).map(([name, category]) => ({
            name,
            category
        }));
        ...
        console.log(`✅ Courses synchronization completed:
